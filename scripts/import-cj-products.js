...
function refineCategory(title, cjCategoryName, fallback, knownSlugs) {
    // Chaque terme est bordé par \b (limite de mot) — sans ça, "ring" matchait
    // aussi "Spring"/"Measuring"/"Drawstring", "art" matchait "Artificial", "car"
    // matchait n'importe quel mot contenant ces lettres. Bug réel confirmé en
    // base : des couteaux de cuisine et vêtements classés "Bijoux" à cause de
    // "Spring"/"Slaughtering" contenant "ring".
    const rules = [
        ...
        [/\b(light|lamp|smart\s?home)\b/, "eclairage-smart-home"],
        ...
        [/\b(art|craft|creativ\w*)\b/, "arts-creativite"],
        [/\b(book|education)\b/, "livres-education"],
        [/\b(clean\w*|organiz\w*)\b/, "entretien-organisation"],
