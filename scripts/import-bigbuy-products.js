...
function refineCategory(title, fallback, knownSlugs) {
    const rules = [
        ...
        [/(furniture)/, "meubles"],
        [/(light|lamp|led|smart home)/, "eclairage-smart-home"],
