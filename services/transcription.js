...
// ==========================================================================
// Transcrit une note vocale WhatsApp/Telegram en texte avant de la passer au
// planner — même chaîne de conversation que pour un message texte, le client
// n'a pas besoin de savoir taper pour se faire comprendre par SAMII.
...
// l'envoie à Groq. Renvoie une chaîne vide si la transcription échoue —
// l'appelant doit prévoir un message de repli plutôt que planter.
