...
const CARDS = [
  ...
  { loi: "T-013", name: "Sérénité", icon: "leaf", desc: "Rapport quotidien apaisé, chaque soir à 22h", available: true },
    { loi: "T-014", name: "Miroir",             icon: "circle-dot",    desc: "Auto-diagnostic de ton activité", available: false },
