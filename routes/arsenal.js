...
const CARDS = [
    { loi: "T-001", name: "Genèse",            icon: "sparkle",       desc: "Identité fondatrice de ta marque", available: true, href: "/samii" },
    { loi: "T-002", name: "Code d'Honneur",     icon: "scroll",        desc: "Charte éthique envers tes clients", available: true, href: "/samii" },
    { loi: "T-003", name: "Vision Clients",     icon: "eye",           desc: "Analyse du sentiment client", available: true, href: "/samii" },
    ...
    { loi: "T-007", name: "Bibliothèque SAMII", icon: "book-open",     desc: "Base de connaissance de ton métier", available: true, href: "/samii" },
    ...
    { loi: "T-010", name: "Verrou de Sécurité", icon: "lock",          desc: "Protection renforcée de ton compte", available: true, href: "/settings" },
    { loi: "T-011", name: "Cadence",            icon: "music",         desc: "Rythme optimal de publication", available: true, href: "/samii" },
    { loi: "T-012", name: "Chronomaître",       icon: "clock",         desc: "Planification multi-fuseaux horaires", available: true, href: "/samii" },
    ...
    { loi: "T-016", name: "Vérité Absolue",     icon: "bar-chart-2",   desc: "Rapport détaillé produits/zones performants", available: true, href: "/samii" },
    { loi: "T-017", name: "Constitution",       icon: "gavel",         desc: "Règles business par défaut", available: true, href: "/samii" },
    { loi: "T-018", name: "Évolution",          icon: "trending-up",   desc: "SAMII apprend de tes résultats", available: true, href: "/samii" },
    { loi: "T-019", name: "Verbe Adaptatif",    icon: "languages",     desc: "Ton de communication ajusté automatiquement", available: true, href: "/samii" },
    ...
    { loi: "T-022", name: "Bouclier Anti-Fraude", icon: "shield-alert", desc: "Vérification renforcée des commandes à risque", available: true, href: "/samii" },
    { loi: "T-023", name: "Radar Opportunités", icon: "radar",         desc: "Analyse quotidienne de tendances", available: true, href: "/samii/opportunites" },
    ...
    { loi: "T-025", name: "Ambassadeur",        icon: "heart-handshake", desc: "Offres de fidélité pour tes clients VIP", available: true, href: "/samii" },
    { loi: "T-026", name: "Griot",              icon: "feather",       desc: "Storytelling automatique de ta marque", available: true, href: "/samii/griot" },
    { loi: "T-027", name: "Artillerie Promo",   icon: "rocket",        desc: "Génère et programme une campagne flash", available: true, href: "/samii" },
    { loi: "T-028", name: "Sanctuaire",         icon: "moon",          desc: "Temps protégé sans interruption", available: true, href: "/samii" },
    { loi: "T-029", name: "Chronos",            icon: "hourglass",     desc: "Automatisation calendaire avancée", available: true, href: "/automatisations" },
    { loi: "T-030", name: "Cartographe",        icon: "map",           desc: "Carte de performance par région", available: true, href: "/samii" },
    { loi: "T-031", name: "Scalpel",            icon: "scissors",      desc: "Aide à la décision rapide", available: true, href: "/samii" },
    { loi: "T-032", name: "Sceau",              icon: "stamp",         desc: "Validation finale avant action critique", available: true, href: "/samii" },
