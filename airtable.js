...
const TABLES = {
    BOUTIQUES      : CONFIG.AIRTABLE.TABLES.BOUTIQUES,
    COMMANDES      : CONFIG.AIRTABLE.TABLES.COMMANDES,
    LOGS           : CONFIG.AIRTABLE.TABLES.LOGS,
    NOTIFICATIONS  : CONFIG.AIRTABLE.TABLES.NOTIFICATIONS,
    AUTOMATISATIONS: CONFIG.AIRTABLE.TABLES.AUTOMATISATIONS,
    JOURNAL        : CONFIG.AIRTABLE.TABLES.JOURNAL,
    LIVRAISONS     : CONFIG.AIRTABLE.TABLES.LIVRAISONS,
};
